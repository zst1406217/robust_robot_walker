...
class A1MixStage2GoalCfg( A1RRWCfg ):
...
class A1MixStage2GoalCfgPPO( A1RRWCfgPPO ):
    class policy(A1RRWCfgPPO.policy):
        scan_encoder_dims = None
        stumble_encoder_dims = [32, 16, 4]
        rnn_type = "lstm"
        has_scan = True if "height_measurements" in A1MixStage2GoalCfg.env.obs_components else False
    ...
    class estimator:
        ...
        class_loss_coeff = 0.
        col_class = [A1MixStage2GoalCfg.terrain.col_bar, A1MixStage2GoalCfg.terrain.col_pit, A1MixStage2GoalCfg.terrain.col_pole,
                    A1MixStage2GoalCfg.terrain.num_cols-A1MixStage2GoalCfg.terrain.col_bar-A1MixStage2GoalCfg.terrain.col_pit-A1MixStage2GoalCfg.terrain.col_pole]
