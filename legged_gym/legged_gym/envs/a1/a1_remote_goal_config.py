...
class A1RemoteGoalCfg( A1RRWCfg ):
...
class A1RemoteGoalCfgPPO( A1RRWCfgPPO ):
    class policy(A1RRWCfgPPO.policy):
        scan_encoder_dims = None
        stumble_encoder_dims = [32, 16, 4]
        rnn_type = "lstm"
        has_scan = True if "height_measurements" in A1RemoteGoalCfg.env.obs_components else False
    ...
    class runner( A1RRWCfgPPO.runner ):
        ...
        amp_reward_coeff = 0.5
        resume = False
        load_run = ""

        run_name = "".join(["WalkByRemoteGoal",
